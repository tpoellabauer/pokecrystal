	...
	tilecoll FLOOR, FLOOR, DOOR, DOOR ; 0b
	...
	tilecoll FLOOR, WALL, DOOR, FLOOR ; 69
	tilecoll DOOR, FLOOR, FLOOR, WALL ; 6a
	tilecoll FLOOR, DOOR, COUNTER, FLOOR ; 6b
	tilecoll WALL, FLOOR, FLOOR, DOOR ; 6c
