	...
	tilecoll FLOOR, STAIRCASE, FLOOR, FLOOR ; 39 (Game Corner hidden staircase, issue #165; only the NE quadrant -- (17, 4) exactly -- is the warp, matching the warp_event's coordinate)
