...
LtSurgeGroup:
	...
	db 18, PIKACHU,    GROWL, THUNDERSHOCK, TAIL_WHIP, THUNDER_WAVE
	db 24, RAICHU,     THUNDERSHOCK, QUICK_ATTACK, THUNDER_WAVE, THUNDERBOLT
	db -1 ; end
...
ErikaGroup:
	...
	db 29, VICTREEBEL, RAZOR_LEAF, ACID, SLEEP_POWDER, STUN_SPORE
	db 24, TANGELA,    VINE_WHIP, BIND, POISONPOWDER, SLEEP_POWDER
	db 29, VILEPLUME,  PETAL_DANCE, ACID, POISONPOWDER, SOLARBEAM
	db -1 ; end
...
PokemaniacGroup:
	...
	; POKEMANIAC (16)
	db "CUBONE_HERMIT@", TRAINERTYPE_NORMAL
	db 23, CUBONE
	db 23, SLOWPOKE
	db -1 ; end

	; POKEMANIAC (17)
	db "POKEMANIAC_ROCKTUNNELB1F1@", TRAINERTYPE_NORMAL
	db 20, SLOWPOKE
	db 20, SLOWPOKE
	db 20, SLOWPOKE
	db -1 ; end
	...
	; POKEMANIAC (18)
	db "POKEMANIAC_ROCKTUNNELB1F2@", TRAINERTYPE_NORMAL
	db 22, CHARMANDER
	db 22, CUBONE
	db -1 ; end

	; POKEMANIAC (19)
	db "POKEMANIAC_ROCKTUNNELB1F3@", TRAINERTYPE_NORMAL
	db 25, SLOWPOKE
	db -1 ; end
...
Rival2Group:
	...
	; RIVAL2 (7)
	db "RIVAL2_POKEMONTOWER_SQUIRTLE@", TRAINERTYPE_NORMAL
	db 25, PIDGEOTTO
	db 23, GROWLITHE
	db 22, EXEGGCUTE
	db 20, KADABRA
	...
	; RIVAL2 (8)
	db "RIVAL2_POKEMONTOWER_BULBASAUR@", TRAINERTYPE_NORMAL
	db 25, PIDGEOTTO
	db 23, GYARADOS
	db 22, GROWLITHE
	db 20, KADABRA
	...
	; RIVAL2 (9)
	db "RIVAL2_POKEMONTOWER_CHARMANDER@", TRAINERTYPE_NORMAL
	db 25, PIDGEOTTO
	db 23, EXEGGCUTE
	db 22, GYARADOS
	db 20, KADABRA
...
HikerGroup:
	...
	; HIKER (26)
	db "HIKER_ROCKTUNNEL1@", TRAINERTYPE_NORMAL
	db 19, GEODUDE
	db 19, MACHOP
	db 19, GEODUDE
	db 19, GEODUDE
	...
	; HIKER (27)
	db "HIKER_ROCKTUNNEL2@", TRAINERTYPE_NORMAL
	db 20, ONIX
	db 20, ONIX
	db 20, GEODUDE
	db -1 ; end
	...
	; HIKER (28)
	db "HIKER_ROCKTUNNEL3@", TRAINERTYPE_NORMAL
	db 21, GEODUDE
	db 21, GRAVELER
	db -1 ; end

	; HIKER (29)
	db "HIKER_ROCKTUNNELB1F1@", TRAINERTYPE_NORMAL
	db 21, GEODUDE
	db 21, GEODUDE
	db 21, GRAVELER
	db -1 ; end
	...
	; HIKER (30)
	db "HIKER_ROCKTUNNELB1F2@", TRAINERTYPE_NORMAL
	db 25, GEODUDE
	db -1 ; end
...
BurglarGroup:
	...
	; BURGLAR (5)
	db "BURGLAR_POKEMON_MANSION_3F@", TRAINERTYPE_NORMAL
	db 38, NINETALES
	db -1 ; end

	; BURGLAR (6)
	db "BURGLAR_POKEMON_MANSION_B1F@", TRAINERTYPE_NORMAL
	db 34, GROWLITHE
	db 34, PONYTA
	db -1 ; end
...
JrTrainerFGroup:
	...
	; JR_TRAINER_F (15)
	db "JR_TRAINER_F_15@", TRAINERTYPE_NORMAL
	db 22, BELLSPROUT
	db 22, CLEFAIRY
	db -1 ; end

	; JR_TRAINER_F (16)
	db "JR_TRAINER_F_16@", TRAINERTYPE_NORMAL
	db 20, MEOWTH
	db 20, ODDISH
	db 20, PIDGEY
	db -1 ; end
	...
	; JR_TRAINER_F (17)
	db "JR_TRAINER_F_17@", TRAINERTYPE_NORMAL
	db 19, PIDGEY
	db 19, RATTATA
	db 19, RATTATA
	db 19, BELLSPROUT
	...
	; JR_TRAINER_F (18)
	db "JR_TRAINER_F_18@", TRAINERTYPE_NORMAL
	db 21, JIGGLYPUFF
	db 21, PIDGEY
	db 21, MEOWTH
	db -1 ; end
	...
	; JR_TRAINER_F (19)
	db "JR_TRAINER_F_19@", TRAINERTYPE_NORMAL
	db 22, ODDISH
	db 22, BULBASAUR
	db -1 ; end
