...
; entries correspond to trainer classes (see constants/trainer_constants.asm)
	...
	dba_pic LoreleiPic ; lorelei (ported from pokeredDisassembly/gfx/trainers/lorelei)
	dba_pic AgathaPic ; agatha (ported from pokeredDisassembly/gfx/trainers/agatha)
