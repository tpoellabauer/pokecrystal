...
MapGroup_Cerulean:
	...
	map CeruleanCity, TILESET_GEN1_OVERWORLD, TOWN, LANDMARK_CERULEAN_CITY, MUSIC_FUCHSIA_CITY, FALSE, PALETTE_AUTO, FISHGROUP_KANTO_GROUP3
...
MapGroup_Fuchsia:
	...
	map FuchsiaCity, TILESET_GEN1_OVERWORLD, TOWN, LANDMARK_FUCHSIA_CITY, MUSIC_FUCHSIA_CITY, FALSE, PALETTE_AUTO, FISHGROUP_KANTO_GROUP10
