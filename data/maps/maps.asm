...
MapGroup_Dungeons:
	...
	map DiglettsCave, TILESET_GEN1_CAVERN, CAVE, LANDMARK_DIGLETTS_CAVE, MUSIC_DUNGEON2, TRUE, PALETTE_NITE, FISHGROUP_SHORE
	...
	map RockTunnel1F, TILESET_GEN1_CAVERN, CAVE, LANDMARK_ROCK_TUNNEL, MUSIC_MT_MOON, TRUE, PALETTE_DARK, FISHGROUP_SHORE
	map RockTunnelB1F, TILESET_GEN1_CAVERN, CAVE, LANDMARK_ROCK_TUNNEL, MUSIC_MT_MOON, TRUE, PALETTE_DARK, FISHGROUP_SHORE
	map SafariZoneFuchsiaGateBeta, TILESET_GATE, INDOOR, LANDMARK_FUCHSIA_CITY, MUSIC_CITIES2, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map ViridianForest, TILESET_GEN1_FOREST, CAVE, LANDMARK_ROUTE_2, MUSIC_DUNGEON2, FALSE, PALETTE_NITE, FISHGROUP_SHORE
	map DiglettsCaveRoute2, TILESET_GEN1_CAVERN, CAVE, LANDMARK_DIGLETTS_CAVE, MUSIC_DUNGEON2, TRUE, PALETTE_NITE, FISHGROUP_SHORE
	map DiglettsCaveRoute11, TILESET_GEN1_CAVERN, CAVE, LANDMARK_DIGLETTS_CAVE, MUSIC_DUNGEON2, TRUE, PALETTE_NITE, FISHGROUP_SHORE
	map UndergroundPathRoute78, TILESET_GATE, GATE, LANDMARK_UNDERGROUND_PATH, MUSIC_ROUTE_3, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Cinnabar:
	table_width MAP_LENGTH
	map CinnabarPokecenter1F, TILESET_GEN1_POKECENTER, INDOOR, LANDMARK_CINNABAR_ISLAND, MUSIC_POKEMON_CENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map Route19, TILESET_GEN1_OVERWORLD, ROUTE, LANDMARK_ROUTE_19, MUSIC_ROUTE_3, FALSE, PALETTE_AUTO, FISHGROUP_KANTO_GROUP8
	map Route20, TILESET_GEN1_OVERWORLD, ROUTE, LANDMARK_ROUTE_20, MUSIC_ROUTE_3, FALSE, PALETTE_AUTO, FISHGROUP_KANTO_GROUP8
	map Route21, TILESET_GEN1_OVERWORLD, ROUTE, LANDMARK_ROUTE_21, MUSIC_ROUTE_3, FALSE, PALETTE_AUTO, FISHGROUP_KANTO_GROUP8
	map CinnabarIsland, TILESET_GEN1_OVERWORLD, TOWN, LANDMARK_CINNABAR_ISLAND, MUSIC_CINNABAR, FALSE, PALETTE_AUTO, FISHGROUP_KANTO_GROUP8
	map PokemonMansion1F, TILESET_GEN1_FACILITY, INDOOR, LANDMARK_CINNABAR_ISLAND, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map PokemonMansion2F, TILESET_GEN1_FACILITY, INDOOR, LANDMARK_CINNABAR_ISLAND, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map PokemonMansion3F, TILESET_GEN1_FACILITY, INDOOR, LANDMARK_CINNABAR_ISLAND, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map PokemonMansionB1F, TILESET_GEN1_FACILITY, INDOOR, LANDMARK_CINNABAR_ISLAND, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SeafoamIslands1F, TILESET_GEN1_CAVERN, CAVE, LANDMARK_SEAFOAM_ISLANDS, MUSIC_MT_MOON, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SeafoamIslandsB1F, TILESET_GEN1_CAVERN, CAVE, LANDMARK_SEAFOAM_ISLANDS, MUSIC_MT_MOON, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SeafoamIslandsB2F, TILESET_GEN1_CAVERN, CAVE, LANDMARK_SEAFOAM_ISLANDS, MUSIC_MT_MOON, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SeafoamIslandsB3F, TILESET_GEN1_CAVERN, CAVE, LANDMARK_SEAFOAM_ISLANDS, MUSIC_MT_MOON, FALSE, PALETTE_DAY, FISHGROUP_KANTO_GROUP8
	map SeafoamIslandsB4F, TILESET_GEN1_CAVERN, CAVE, LANDMARK_SEAFOAM_ISLANDS, MUSIC_MT_MOON, FALSE, PALETTE_DAY, FISHGROUP_KANTO_GROUP8
	map CinnabarGym, TILESET_GEN1_FACILITY, INDOOR, LANDMARK_CINNABAR_ISLAND, MUSIC_GYM, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map CinnabarLab, TILESET_GEN1_LAB, INDOOR, LANDMARK_CINNABAR_ISLAND, MUSIC_CINNABAR, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map CinnabarMart, TILESET_GEN1_MART, INDOOR, LANDMARK_CINNABAR_ISLAND, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map CinnabarLabTradeRoom, TILESET_GEN1_LAB, INDOOR, LANDMARK_CINNABAR_ISLAND, MUSIC_CINNABAR, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map CinnabarLabMetronomeRoom, TILESET_GEN1_LAB, INDOOR, LANDMARK_CINNABAR_ISLAND, MUSIC_CINNABAR, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map CinnabarLabFossilRoom, TILESET_GEN1_LAB, INDOOR, LANDMARK_CINNABAR_ISLAND, MUSIC_CINNABAR, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Cerulean:
	...
	map CeruleanPokecenter1F, TILESET_GEN1_POKECENTER, INDOOR, LANDMARK_CERULEAN_CITY, MUSIC_POKEMON_CENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map CeruleanGym, TILESET_GEN1_GYM, INDOOR, LANDMARK_CERULEAN_CITY, MUSIC_GYM, TRUE, PALETTE_DAY, FISHGROUP_KANTO_GROUP3
	map CeruleanMart, TILESET_GEN1_MART, INDOOR, LANDMARK_CERULEAN_CITY, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map PowerPlant, TILESET_GEN1_FACILITY, INDOOR, LANDMARK_POWER_PLANT, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map BillsHouse, TILESET_GEN1_INTERIOR, INDOOR, LANDMARK_ROUTE_25, MUSIC_FUCHSIA_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map Route4, TILESET_GEN1_OVERWORLD, ROUTE, LANDMARK_ROUTE_4, MUSIC_ROUTE_3, FALSE, PALETTE_AUTO, FISHGROUP_KANTO_GROUP3
	map Route9, TILESET_GEN1_OVERWORLD, ROUTE, LANDMARK_ROUTE_9, MUSIC_ROUTE_3, FALSE, PALETTE_AUTO, FISHGROUP_LAKE
	map Route10North, TILESET_KANTO, ROUTE, LANDMARK_ROUTE_10, MUSIC_ROUTE_3, FALSE, PALETTE_AUTO, FISHGROUP_KANTO_GROUP5
	map Route24, TILESET_GEN1_OVERWORLD, ROUTE, LANDMARK_ROUTE_24, MUSIC_ROUTE_2, FALSE, PALETTE_AUTO, FISHGROUP_KANTO_GROUP3
	map Route25, TILESET_GEN1_OVERWORLD, ROUTE, LANDMARK_ROUTE_25, MUSIC_ROUTE_3, FALSE, PALETTE_AUTO, FISHGROUP_KANTO_GROUP3
	map CeruleanCity, TILESET_GEN1_OVERWORLD, TOWN, LANDMARK_CERULEAN_CITY, MUSIC_CITIES2, FALSE, PALETTE_AUTO, FISHGROUP_KANTO_GROUP3
	map CeruleanCave1F, TILESET_GEN1_CAVERN, CAVE, LANDMARK_CERULEAN_CITY, MUSIC_MT_MOON, FALSE, PALETTE_DAY, FISHGROUP_KANTO_GROUP9
	map CeruleanCave2F, TILESET_GEN1_CAVERN, CAVE, LANDMARK_CERULEAN_CITY, MUSIC_MT_MOON, FALSE, PALETTE_DAY, FISHGROUP_KANTO_GROUP9
	map CeruleanCaveB1F, TILESET_GEN1_CAVERN, CAVE, LANDMARK_CERULEAN_CITY, MUSIC_MT_MOON, FALSE, PALETTE_DAY, FISHGROUP_KANTO_GROUP9
...
MapGroup_Vermilion:
	table_width MAP_LENGTH
	map Route6, TILESET_GEN1_OVERWORLD, ROUTE, LANDMARK_ROUTE_6, MUSIC_ROUTE_3, FALSE, PALETTE_AUTO, FISHGROUP_KANTO_GROUP4
	map Route11, TILESET_GEN1_OVERWORLD, ROUTE, LANDMARK_ROUTE_11, MUSIC_ROUTE_12, FALSE, PALETTE_AUTO, FISHGROUP_KANTO_GROUP4
	map VermilionCity, TILESET_GEN1_OVERWORLD, TOWN, LANDMARK_VERMILION_CITY, MUSIC_VERMILION_CITY, FALSE, PALETTE_AUTO, FISHGROUP_KANTO_GROUP4
	...
	map VermilionPokecenter1F, TILESET_GEN1_POKECENTER, INDOOR, LANDMARK_VERMILION_CITY, MUSIC_POKEMON_CENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map PokemonFanClub, TILESET_GEN1_INTERIOR, INDOOR, LANDMARK_VERMILION_CITY, MUSIC_VERMILION_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map VermilionMart, TILESET_GEN1_MART, INDOOR, LANDMARK_VERMILION_CITY, MUSIC_VERMILION_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map VermilionGym, TILESET_GEN1_GYM, INDOOR, LANDMARK_VERMILION_CITY, MUSIC_GYM, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	map Route6SaffronGate, TILESET_GEN1_GATE, GATE, LANDMARK_ROUTE_6, MUSIC_ROUTE_3, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map Route6UndergroundPathEntrance, TILESET_GATE, GATE, LANDMARK_ROUTE_6, MUSIC_ROUTE_3, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map VermilionPidgeyHouse, TILESET_GEN1_HOUSE, INDOOR, LANDMARK_VERMILION_CITY, MUSIC_VERMILION_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map VermilionTradeHouse, TILESET_GEN1_HOUSE, INDOOR, LANDMARK_VERMILION_CITY, MUSIC_VERMILION_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map VermilionOldRodHouse, TILESET_GEN1_HOUSE, INDOOR, LANDMARK_VERMILION_CITY, MUSIC_FUCHSIA_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Pallet:
	table_width MAP_LENGTH
	map Route1, TILESET_GEN1_OVERWORLD, ROUTE, LANDMARK_ROUTE_1, MUSIC_ROUTE_1, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map PalletTown, TILESET_GEN1_OVERWORLD, TOWN, LANDMARK_PALLET_TOWN, MUSIC_PALLET_TOWN, FALSE, PALETTE_AUTO, FISHGROUP_KANTO_GROUP1
	map RedsHouse1F, TILESET_GEN1_REDS_HOUSE, INDOOR, LANDMARK_PALLET_TOWN, MUSIC_PALLET_TOWN, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map RedsHouse2F, TILESET_GEN1_REDS_HOUSE, INDOOR, LANDMARK_PALLET_TOWN, MUSIC_PALLET_TOWN, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map BluesHouse, TILESET_GEN1_HOUSE, INDOOR, LANDMARK_PALLET_TOWN, MUSIC_PALLET_TOWN, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map OaksLab, TILESET_GEN1_DOJO, INDOOR, LANDMARK_PALLET_TOWN, MUSIC_PROF_OAK, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	assert_table_length NUM_PALLET_MAPS

MapGroup_Pewter:
	table_width MAP_LENGTH
	map Route3, TILESET_GEN1_OVERWORLD, ROUTE, LANDMARK_ROUTE_3, MUSIC_ROUTE_3, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map PewterCity, TILESET_GEN1_OVERWORLD, TOWN, LANDMARK_PEWTER_CITY, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	...
	map PewterGym, TILESET_GEN1_GYM, INDOOR, LANDMARK_PEWTER_CITY, MUSIC_GYM, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	map PewterMart, TILESET_GEN1_MART, INDOOR, LANDMARK_PEWTER_CITY, MUSIC_POKEMON_CENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map PewterPokecenter1F, TILESET_GEN1_POKECENTER, INDOOR, LANDMARK_PEWTER_CITY, MUSIC_POKEMON_CENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map Museum1F, TILESET_GEN1_MUSEUM, INDOOR, LANDMARK_PEWTER_CITY, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map Museum2F, TILESET_GEN1_MUSEUM, INDOOR, LANDMARK_PEWTER_CITY, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_FastShip:
	...
	map VermilionPort, TILESET_PORT, ROUTE, LANDMARK_VERMILION_CITY, MUSIC_VERMILION_CITY, FALSE, PALETTE_AUTO, FISHGROUP_KANTO_GROUP4
	...
	map SSAnne1F, TILESET_GEN1_SHIP, INDOOR, LANDMARK_VERMILION_CITY, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SSAnne2F, TILESET_GEN1_SHIP, INDOOR, LANDMARK_VERMILION_CITY, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SSAnne3F, TILESET_GEN1_SHIP, INDOOR, LANDMARK_VERMILION_CITY, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SSAnneB1F, TILESET_GEN1_SHIP, INDOOR, LANDMARK_VERMILION_CITY, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SSAnneBow, TILESET_GEN1_SHIP, INDOOR, LANDMARK_VERMILION_CITY, MUSIC_SS_ANNE, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SSAnneKitchen, TILESET_GEN1_SHIP, INDOOR, LANDMARK_VERMILION_CITY, MUSIC_SS_ANNE, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SSAnneCaptainsRoom, TILESET_GEN1_SHIP, INDOOR, LANDMARK_VERMILION_CITY, MUSIC_SS_ANNE, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SSAnne1FRooms, TILESET_GEN1_SHIP, INDOOR, LANDMARK_VERMILION_CITY, MUSIC_SS_ANNE, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SSAnne2FRooms, TILESET_GEN1_SHIP, INDOOR, LANDMARK_VERMILION_CITY, MUSIC_SS_ANNE, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SSAnneB1FRooms, TILESET_GEN1_SHIP, INDOOR, LANDMARK_VERMILION_CITY, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	assert_table_length NUM_FAST_SHIP_MAPS

MapGroup_Indigo:
	table_width MAP_LENGTH
	map Route23, TILESET_GEN1_PLATEAU, TOWN, LANDMARK_ROUTE_23, MUSIC_INDIGO_PLATEAU, FALSE, PALETTE_AUTO, FISHGROUP_KANTO_GROUP9
	...
	map WillsRoom, TILESET_GEN1_GYM, INDOOR, LANDMARK_INDIGO_PLATEAU, MUSIC_INDIGO_PLATEAU, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	map KogasRoom, TILESET_GEN1_GYM, INDOOR, LANDMARK_INDIGO_PLATEAU, MUSIC_INDIGO_PLATEAU, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	map BrunosRoom, TILESET_GEN1_CEMETERY, INDOOR, LANDMARK_INDIGO_PLATEAU, MUSIC_INDIGO_PLATEAU, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	map KarensRoom, TILESET_GEN1_DOJO, INDOOR, LANDMARK_INDIGO_PLATEAU, MUSIC_INDIGO_PLATEAU, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	map LancesRoom, TILESET_GEN1_GYM, INDOOR, LANDMARK_INDIGO_PLATEAU, MUSIC_INDIGO_PLATEAU, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	map HallOfFame, TILESET_GEN1_GYM, INDOOR, LANDMARK_INDIGO_PLATEAU, MUSIC_NEW_BARK_TOWN, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	assert_table_length NUM_INDIGO_MAPS

MapGroup_Fuchsia:
	table_width MAP_LENGTH
	map Route13, TILESET_GEN1_OVERWORLD, ROUTE, LANDMARK_ROUTE_13, MUSIC_ROUTE_12, FALSE, PALETTE_AUTO, FISHGROUP_KANTO_GROUP7
	map Route14, TILESET_GEN1_OVERWORLD, ROUTE, LANDMARK_ROUTE_14, MUSIC_ROUTE_12, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map Route15, TILESET_GEN1_OVERWORLD, ROUTE, LANDMARK_ROUTE_15, MUSIC_ROUTE_12, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map Route18, TILESET_GEN1_OVERWORLD, ROUTE, LANDMARK_ROUTE_18, MUSIC_ROUTE_3, FALSE, PALETTE_AUTO, FISHGROUP_KANTO_GROUP7
	map FuchsiaCity, TILESET_GEN1_OVERWORLD, TOWN, LANDMARK_FUCHSIA_CITY, MUSIC_CITIES2, FALSE, PALETTE_AUTO, FISHGROUP_KANTO_GROUP10
	map FuchsiaMart, TILESET_GEN1_MART, INDOOR, LANDMARK_FUCHSIA_CITY, MUSIC_POKEMON_CENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map FuchsiaGym, TILESET_GEN1_GYM, INDOOR, LANDMARK_FUCHSIA_CITY, MUSIC_GYM, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map FuchsiaPokecenter1F, TILESET_GEN1_POKECENTER, INDOOR, LANDMARK_FUCHSIA_CITY, MUSIC_POKEMON_CENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map SafariZoneCenter, TILESET_GEN1_FOREST, ROUTE, LANDMARK_FUCHSIA_CITY, MUSIC_SAFARI_ZONE, FALSE, PALETTE_DAY, FISHGROUP_KANTO_GROUP6
	map SafariZoneEast, TILESET_GEN1_FOREST, ROUTE, LANDMARK_FUCHSIA_CITY, MUSIC_SAFARI_ZONE, FALSE, PALETTE_DAY, FISHGROUP_KANTO_GROUP6
	map SafariZoneNorth, TILESET_GEN1_FOREST, ROUTE, LANDMARK_FUCHSIA_CITY, MUSIC_SAFARI_ZONE, FALSE, PALETTE_DAY, FISHGROUP_KANTO_GROUP6
	map SafariZoneWest, TILESET_GEN1_FOREST, ROUTE, LANDMARK_FUCHSIA_CITY, MUSIC_SAFARI_ZONE, FALSE, PALETTE_DAY, FISHGROUP_KANTO_GROUP6
	map SafariZoneGate, TILESET_GEN1_GATE, INDOOR, LANDMARK_FUCHSIA_CITY, MUSIC_FUCHSIA_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SafariZoneCenterRestHouse, TILESET_GEN1_GATE, INDOOR, LANDMARK_FUCHSIA_CITY, MUSIC_SAFARI_ZONE, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SafariZoneEastRestHouse, TILESET_GEN1_GATE, INDOOR, LANDMARK_FUCHSIA_CITY, MUSIC_SAFARI_ZONE, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SafariZoneNorthRestHouse, TILESET_GEN1_GATE, INDOOR, LANDMARK_FUCHSIA_CITY, MUSIC_SAFARI_ZONE, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SafariZoneWestRestHouse, TILESET_GEN1_GATE, INDOOR, LANDMARK_FUCHSIA_CITY, MUSIC_SAFARI_ZONE, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SafariZoneSecretHouse, TILESET_GEN1_LAB, INDOOR, LANDMARK_FUCHSIA_CITY, MUSIC_SAFARI_ZONE, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map FuchsiaGoodRodHouse, TILESET_GEN1_SHIP, INDOOR, LANDMARK_FUCHSIA_CITY, MUSIC_FUCHSIA_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map Route15Gate, TILESET_GATE, GATE, LANDMARK_ROUTE_15, MUSIC_ROUTE_12, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	assert_table_length NUM_FUCHSIA_MAPS

MapGroup_Lavender:
	table_width MAP_LENGTH
	map Route8, TILESET_GEN1_OVERWORLD, ROUTE, LANDMARK_ROUTE_8, MUSIC_ROUTE_3, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map Route12, TILESET_GEN1_OVERWORLD, ROUTE, LANDMARK_ROUTE_12, MUSIC_ROUTE_12, FALSE, PALETTE_AUTO, FISHGROUP_KANTO_GROUP7
	map Route10South, TILESET_KANTO, ROUTE, LANDMARK_ROUTE_10, MUSIC_ROUTE_3, FALSE, PALETTE_AUTO, FISHGROUP_KANTO_GROUP5
	map LavenderTown, TILESET_GEN1_OVERWORLD, TOWN, LANDMARK_LAVENDER_TOWN, MUSIC_LAVENDER_TOWN, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map LavenderPokecenter1F, TILESET_GEN1_POKECENTER, INDOOR, LANDMARK_LAVENDER_TOWN, MUSIC_POKEMON_CENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map MrFujisHouse, TILESET_GEN1_HOUSE, INDOOR, LANDMARK_LAVENDER_TOWN, MUSIC_LAVENDER_TOWN, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map LavenderMart, TILESET_GEN1_MART, INDOOR, LANDMARK_LAVENDER_TOWN, MUSIC_LAVENDER_TOWN, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map Route12SuperRodHouse, TILESET_GEN1_HOUSE, INDOOR, LANDMARK_ROUTE_12, MUSIC_CELADON_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map PokemonTower1F, TILESET_GEN1_CEMETERY, INDOOR, LANDMARK_LAVENDER_TOWN, MUSIC_LAVENDER_TOWN, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map PokemonTower2F, TILESET_GEN1_CEMETERY, INDOOR, LANDMARK_LAVENDER_TOWN, MUSIC_LAVENDER_TOWN, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map PokemonTower3F, TILESET_GEN1_CEMETERY, INDOOR, LANDMARK_LAVENDER_TOWN, MUSIC_LAVENDER_TOWN, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map PokemonTower4F, TILESET_GEN1_CEMETERY, INDOOR, LANDMARK_LAVENDER_TOWN, MUSIC_LAVENDER_TOWN, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map PokemonTower5F, TILESET_GEN1_CEMETERY, INDOOR, LANDMARK_LAVENDER_TOWN, MUSIC_LAVENDER_TOWN, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map PokemonTower6F, TILESET_GEN1_CEMETERY, INDOOR, LANDMARK_LAVENDER_TOWN, MUSIC_LAVENDER_TOWN, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map PokemonTower7F, TILESET_GEN1_CEMETERY, INDOOR, LANDMARK_LAVENDER_TOWN, MUSIC_LAVENDER_TOWN, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map Route12Gate, TILESET_GEN1_GATE, GATE, LANDMARK_ROUTE_12, MUSIC_ROUTE_12, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_CableClub:
	...
	map TradeCenter, TILESET_GEN1_CLUB, INDOOR, LANDMARK_SPECIAL, MUSIC_CHERRYGROVE_CITY, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	map Colosseum, TILESET_GEN1_CLUB, INDOOR, LANDMARK_SPECIAL, MUSIC_CHERRYGROVE_CITY, TRUE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Celadon:
	table_width MAP_LENGTH
	map Route7, TILESET_GEN1_OVERWORLD, ROUTE, LANDMARK_ROUTE_7, MUSIC_ROUTE_3, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map Route16, TILESET_GEN1_OVERWORLD, ROUTE, LANDMARK_ROUTE_16, MUSIC_ROUTE_3, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map Route17, TILESET_GEN1_OVERWORLD, ROUTE, LANDMARK_ROUTE_17, MUSIC_ROUTE_3, FALSE, PALETTE_AUTO, FISHGROUP_KANTO_GROUP7
	map CeladonCity, TILESET_GEN1_OVERWORLD, TOWN, LANDMARK_CELADON_CITY, MUSIC_CELADON_CITY, FALSE, PALETTE_AUTO, FISHGROUP_KANTO_GROUP5
	...
	map CeladonMansion1F, TILESET_GEN1_MANSION, INDOOR, LANDMARK_CELADON_CITY, MUSIC_CELADON_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map CeladonMansion2F, TILESET_GEN1_MANSION, INDOOR, LANDMARK_CELADON_CITY, MUSIC_CELADON_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map CeladonMansion3F, TILESET_GEN1_MANSION, INDOOR, LANDMARK_CELADON_CITY, MUSIC_CELADON_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map CeladonMansionRoof, TILESET_GEN1_MANSION, INDOOR, LANDMARK_CELADON_CITY, MUSIC_CELADON_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map CeladonMansionRoofHouse, TILESET_GEN1_HOUSE, INDOOR, LANDMARK_CELADON_CITY, MUSIC_CELADON_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map CeladonPokecenter1F, TILESET_GEN1_POKECENTER, INDOOR, LANDMARK_CELADON_CITY, MUSIC_POKEMON_CENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map CeladonGym, TILESET_GEN1_GYM, INDOOR, LANDMARK_CELADON_CITY, MUSIC_GYM, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map RocketHideoutB1F, TILESET_GEN1_FACILITY, INDOOR, LANDMARK_CELADON_CITY, MUSIC_ROCKET_HIDEOUT, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map RocketHideoutB2F, TILESET_GEN1_FACILITY, INDOOR, LANDMARK_CELADON_CITY, MUSIC_ROCKET_HIDEOUT, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map RocketHideoutB3F, TILESET_GEN1_FACILITY, INDOOR, LANDMARK_CELADON_CITY, MUSIC_ROCKET_HIDEOUT, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map RocketHideoutB4F, TILESET_GEN1_FACILITY, INDOOR, LANDMARK_CELADON_CITY, MUSIC_ROCKET_HIDEOUT, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map RocketHideoutElevator, TILESET_GEN1_LOBBY, INDOOR, LANDMARK_CELADON_CITY, MUSIC_ROCKET_HIDEOUT, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map Route7Gate, TILESET_GATE, GATE, LANDMARK_ROUTE_7, MUSIC_ROUTE_3, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Viridian:
	table_width MAP_LENGTH
	map Route2, TILESET_GEN1_OVERWORLD, ROUTE, LANDMARK_ROUTE_2, MUSIC_ROUTE_1, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map Route22, TILESET_GEN1_OVERWORLD, ROUTE, LANDMARK_ROUTE_22, MUSIC_ROUTE_3, FALSE, PALETTE_AUTO, FISHGROUP_KANTO_GROUP2
	map ViridianCity, TILESET_GEN1_OVERWORLD, TOWN, LANDMARK_VIRIDIAN_CITY, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_AUTO, FISHGROUP_KANTO_GROUP1
	map ViridianGym, TILESET_GEN1_GYM, INDOOR, LANDMARK_VIRIDIAN_CITY, MUSIC_GYM, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map ViridianMart, TILESET_GEN1_MART, INDOOR, LANDMARK_VIRIDIAN_CITY, MUSIC_POKEMON_CENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map ViridianPokecenter1F, TILESET_GEN1_POKECENTER, INDOOR, LANDMARK_VIRIDIAN_CITY, MUSIC_POKEMON_CENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map Route2Gate, TILESET_GEN1_GATE, GATE, LANDMARK_ROUTE_2, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map VictoryRoadGate, TILESET_GATE, GATE, LANDMARK_ROUTE_26, MUSIC_INDIGO_PLATEAU, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map Route2TradeHouse, TILESET_GEN1_HOUSE, INDOOR, LANDMARK_ROUTE_2, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map ViridianForestNorthGate, TILESET_GEN1_FOREST_GATE, GATE, LANDMARK_ROUTE_2, MUSIC_ROUTE_2, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map ViridianForestSouthGate, TILESET_GEN1_FOREST_GATE, GATE, LANDMARK_ROUTE_2, MUSIC_ROUTE_2, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map ViridianSchoolHouse, TILESET_GEN1_HOUSE, INDOOR, LANDMARK_VIRIDIAN_CITY, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Saffron:
	table_width MAP_LENGTH
	map Route5, TILESET_GEN1_OVERWORLD, ROUTE, LANDMARK_ROUTE_5, MUSIC_ROUTE_3, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map SaffronCity, TILESET_GEN1_OVERWORLD, TOWN, LANDMARK_SAFFRON_CITY, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	...
	map SaffronGym, TILESET_GEN1_FACILITY, INDOOR, LANDMARK_SAFFRON_CITY, MUSIC_GYM, TRUE, PALETTE_DAY, FISHGROUP_SHORE
	map SaffronMart, TILESET_GEN1_MART, INDOOR, LANDMARK_SAFFRON_CITY, MUSIC_POKEMON_CENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SaffronPokecenter1F, TILESET_GEN1_POKECENTER, INDOOR, LANDMARK_SAFFRON_CITY, MUSIC_POKEMON_CENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map MrPsychicsHouse, TILESET_GEN1_HOUSE, INDOOR, LANDMARK_SAFFRON_CITY, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map SilphCo1F, TILESET_GEN1_FACILITY, INDOOR, LANDMARK_SAFFRON_CITY, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map CopycatsHouse1F, TILESET_GEN1_REDS_HOUSE, INDOOR, LANDMARK_SAFFRON_CITY, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map CopycatsHouse2F, TILESET_GEN1_REDS_HOUSE, INDOOR, LANDMARK_SAFFRON_CITY, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map SilphCo2F, TILESET_GEN1_FACILITY, INDOOR, LANDMARK_SAFFRON_CITY, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SilphCo3F, TILESET_GEN1_FACILITY, INDOOR, LANDMARK_SAFFRON_CITY, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SilphCo4F, TILESET_GEN1_FACILITY, INDOOR, LANDMARK_SAFFRON_CITY, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SilphCo5F, TILESET_GEN1_FACILITY, INDOOR, LANDMARK_SAFFRON_CITY, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SilphCo6F, TILESET_GEN1_FACILITY, INDOOR, LANDMARK_SAFFRON_CITY, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SilphCo7F, TILESET_GEN1_FACILITY, INDOOR, LANDMARK_SAFFRON_CITY, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SilphCo8F, TILESET_GEN1_FACILITY, INDOOR, LANDMARK_SAFFRON_CITY, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SilphCo9F, TILESET_GEN1_FACILITY, INDOOR, LANDMARK_SAFFRON_CITY, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SilphCo10F, TILESET_GEN1_FACILITY, INDOOR, LANDMARK_SAFFRON_CITY, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SilphCo11F, TILESET_GEN1_INTERIOR, INDOOR, LANDMARK_SAFFRON_CITY, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SilphCoElevator, TILESET_GEN1_LOBBY, INDOOR, LANDMARK_SAFFRON_CITY, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SaffronPidgeyHouse, TILESET_GEN1_HOUSE, INDOOR, LANDMARK_SAFFRON_CITY, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map Route5DayCare, TILESET_GEN1_HOUSE, INDOOR, LANDMARK_ROUTE_5, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
