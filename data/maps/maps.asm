...
MapGroup_Dungeons:
	...
	map DiglettsCave, TILESET_GEN1_CAVERN, CAVE, LANDMARK_DIGLETTS_CAVE, MUSIC_MT_MOON, TRUE, PALETTE_NITE, FISHGROUP_SHORE
	...
	map ViridianForest, TILESET_GEN1_FOREST, CAVE, LANDMARK_ROUTE_2, MUSIC_ROUTE_2, FALSE, PALETTE_NITE, FISHGROUP_SHORE
	map DiglettsCaveRoute2, TILESET_GEN1_CAVERN, CAVE, LANDMARK_DIGLETTS_CAVE, MUSIC_MT_MOON, TRUE, PALETTE_NITE, FISHGROUP_SHORE
	map DiglettsCaveRoute11, TILESET_GEN1_CAVERN, CAVE, LANDMARK_DIGLETTS_CAVE, MUSIC_MT_MOON, TRUE, PALETTE_NITE, FISHGROUP_SHORE
...
MapGroup_Cinnabar:
	...
	map CinnabarIsland, TILESET_GEN1_OVERWORLD, TOWN, LANDMARK_CINNABAR_ISLAND, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_AUTO, FISHGROUP_KANTO_GROUP8
	...
	map CinnabarLab, TILESET_GEN1_LAB, INDOOR, LANDMARK_CINNABAR_ISLAND, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map CinnabarMart, TILESET_GEN1_MART, INDOOR, LANDMARK_CINNABAR_ISLAND, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map CinnabarLabTradeRoom, TILESET_GEN1_LAB, INDOOR, LANDMARK_CINNABAR_ISLAND, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map CinnabarLabMetronomeRoom, TILESET_GEN1_LAB, INDOOR, LANDMARK_CINNABAR_ISLAND, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map CinnabarLabFossilRoom, TILESET_GEN1_LAB, INDOOR, LANDMARK_CINNABAR_ISLAND, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Cerulean:
	...
	map BillsHouse, TILESET_GEN1_INTERIOR, INDOOR, LANDMARK_ROUTE_25, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map Route24, TILESET_GEN1_OVERWORLD, ROUTE, LANDMARK_ROUTE_24, MUSIC_ROUTE_3, FALSE, PALETTE_AUTO, FISHGROUP_KANTO_GROUP3
	map Route25, TILESET_GEN1_OVERWORLD, ROUTE, LANDMARK_ROUTE_25, MUSIC_ROUTE_3, FALSE, PALETTE_AUTO, FISHGROUP_KANTO_GROUP3
	map CeruleanCity, TILESET_GEN1_OVERWORLD, TOWN, LANDMARK_CERULEAN_CITY, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_AUTO, FISHGROUP_KANTO_GROUP3
...
MapGroup_Vermilion:
	...
	map VermilionOldRodHouse, TILESET_GEN1_HOUSE, INDOOR, LANDMARK_VERMILION_CITY, MUSIC_VERMILION_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Pewter:
	...
	map PewterMart, TILESET_GEN1_MART, INDOOR, LANDMARK_PEWTER_CITY, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_FastShip:
	...
	map SSAnneBow, TILESET_GEN1_SHIP, INDOOR, LANDMARK_VERMILION_CITY, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SSAnneKitchen, TILESET_GEN1_SHIP, INDOOR, LANDMARK_VERMILION_CITY, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SSAnneCaptainsRoom, TILESET_GEN1_SHIP, INDOOR, LANDMARK_VERMILION_CITY, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SSAnne1FRooms, TILESET_GEN1_SHIP, INDOOR, LANDMARK_VERMILION_CITY, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SSAnne2FRooms, TILESET_GEN1_SHIP, INDOOR, LANDMARK_VERMILION_CITY, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Fuchsia:
	...
	map FuchsiaCity, TILESET_GEN1_OVERWORLD, TOWN, LANDMARK_FUCHSIA_CITY, MUSIC_CELADON_CITY, FALSE, PALETTE_AUTO, FISHGROUP_KANTO_GROUP10
	...
	map SafariZoneCenter, TILESET_GEN1_FOREST, ROUTE, LANDMARK_FUCHSIA_CITY, MUSIC_ROUTE_3, FALSE, PALETTE_DAY, FISHGROUP_KANTO_GROUP6
	map SafariZoneEast, TILESET_GEN1_FOREST, ROUTE, LANDMARK_FUCHSIA_CITY, MUSIC_ROUTE_3, FALSE, PALETTE_DAY, FISHGROUP_KANTO_GROUP6
	map SafariZoneNorth, TILESET_GEN1_FOREST, ROUTE, LANDMARK_FUCHSIA_CITY, MUSIC_ROUTE_3, FALSE, PALETTE_DAY, FISHGROUP_KANTO_GROUP6
	map SafariZoneWest, TILESET_GEN1_FOREST, ROUTE, LANDMARK_FUCHSIA_CITY, MUSIC_ROUTE_3, FALSE, PALETTE_DAY, FISHGROUP_KANTO_GROUP6
	map SafariZoneGate, TILESET_GEN1_GATE, INDOOR, LANDMARK_FUCHSIA_CITY, MUSIC_POKEMON_CENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SafariZoneCenterRestHouse, TILESET_GEN1_GATE, INDOOR, LANDMARK_FUCHSIA_CITY, MUSIC_POKEMON_CENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SafariZoneEastRestHouse, TILESET_GEN1_GATE, INDOOR, LANDMARK_FUCHSIA_CITY, MUSIC_POKEMON_CENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SafariZoneNorthRestHouse, TILESET_GEN1_GATE, INDOOR, LANDMARK_FUCHSIA_CITY, MUSIC_POKEMON_CENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SafariZoneWestRestHouse, TILESET_GEN1_GATE, INDOOR, LANDMARK_FUCHSIA_CITY, MUSIC_POKEMON_CENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SafariZoneSecretHouse, TILESET_GEN1_LAB, INDOOR, LANDMARK_FUCHSIA_CITY, MUSIC_POKEMON_CENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map FuchsiaGoodRodHouse, TILESET_GEN1_SHIP, INDOOR, LANDMARK_FUCHSIA_CITY, MUSIC_CELADON_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Viridian:
	...
	map Route2Gate, TILESET_GEN1_GATE, GATE, LANDMARK_ROUTE_2, MUSIC_ROUTE_2, FALSE, PALETTE_DAY, FISHGROUP_SHORE
