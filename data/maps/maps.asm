...
MapGroup_Cinnabar:
	...
	map Route19, TILESET_GEN1_OVERWORLD, ROUTE, LANDMARK_ROUTE_19, MUSIC_ROUTE_3, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map Route20, TILESET_GEN1_OVERWORLD, ROUTE, LANDMARK_ROUTE_20, MUSIC_ROUTE_3, FALSE, PALETTE_AUTO, FISHGROUP_OCEAN
	map Route21, TILESET_GEN1_OVERWORLD, ROUTE, LANDMARK_ROUTE_21, MUSIC_ROUTE_3, FALSE, PALETTE_AUTO, FISHGROUP_OCEAN
	map CinnabarIsland, TILESET_GEN1_OVERWORLD, TOWN, LANDMARK_CINNABAR_ISLAND, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_AUTO, FISHGROUP_OCEAN
	...
	map SeafoamIslandsB3F, TILESET_GEN1_CAVERN, CAVE, LANDMARK_SEAFOAM_ISLANDS, MUSIC_MT_MOON, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SeafoamIslandsB4F, TILESET_GEN1_CAVERN, CAVE, LANDMARK_SEAFOAM_ISLANDS, MUSIC_MT_MOON, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Cerulean:
	...
	map CeruleanGym, TILESET_GEN1_GYM, INDOOR, LANDMARK_CERULEAN_CITY, MUSIC_GYM, TRUE, PALETTE_DAY, FISHGROUP_NONE
	...
	map Route4, TILESET_GEN1_OVERWORLD, ROUTE, LANDMARK_ROUTE_4, MUSIC_ROUTE_3, FALSE, PALETTE_AUTO, FISHGROUP_NONE
	...
	map Route24, TILESET_GEN1_OVERWORLD, ROUTE, LANDMARK_ROUTE_24, MUSIC_ROUTE_3, FALSE, PALETTE_AUTO, FISHGROUP_LAKE
	map Route25, TILESET_GEN1_OVERWORLD, ROUTE, LANDMARK_ROUTE_25, MUSIC_ROUTE_3, FALSE, PALETTE_AUTO, FISHGROUP_LAKE
	map CeruleanCity, TILESET_GEN1_OVERWORLD, TOWN, LANDMARK_CERULEAN_CITY, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_AUTO, FISHGROUP_NONE
	map CeruleanCave1F, TILESET_GEN1_CAVERN, CAVE, LANDMARK_CERULEAN_CITY, MUSIC_MT_MOON, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map CeruleanCave2F, TILESET_GEN1_CAVERN, CAVE, LANDMARK_CERULEAN_CITY, MUSIC_MT_MOON, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map CeruleanCaveB1F, TILESET_GEN1_CAVERN, CAVE, LANDMARK_CERULEAN_CITY, MUSIC_MT_MOON, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Vermilion:
	table_width MAP_LENGTH
	map Route6, TILESET_GEN1_OVERWORLD, ROUTE, LANDMARK_ROUTE_6, MUSIC_ROUTE_3, FALSE, PALETTE_AUTO, FISHGROUP_POND
	map Route11, TILESET_GEN1_OVERWORLD, ROUTE, LANDMARK_ROUTE_11, MUSIC_ROUTE_12, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map VermilionCity, TILESET_GEN1_OVERWORLD, TOWN, LANDMARK_VERMILION_CITY, MUSIC_VERMILION_CITY, FALSE, PALETTE_AUTO, FISHGROUP_OCEAN
...
MapGroup_Pallet:
	...
	map PalletTown, TILESET_GEN1_OVERWORLD, TOWN, LANDMARK_PALLET_TOWN, MUSIC_PALLET_TOWN, FALSE, PALETTE_AUTO, FISHGROUP_OCEAN
...
MapGroup_Indigo:
	table_width MAP_LENGTH
	map Route23, TILESET_GEN1_PLATEAU, TOWN, LANDMARK_ROUTE_23, MUSIC_INDIGO_PLATEAU, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
...
MapGroup_Fuchsia:
	table_width MAP_LENGTH
	map Route13, TILESET_GEN1_OVERWORLD, ROUTE, LANDMARK_ROUTE_13, MUSIC_ROUTE_12, FALSE, PALETTE_AUTO, FISHGROUP_QWILFISH_NO_SWARM
	...
	map Route18, TILESET_GEN1_OVERWORLD, ROUTE, LANDMARK_ROUTE_18, MUSIC_ROUTE_3, FALSE, PALETTE_AUTO, FISHGROUP_SHORE
	map FuchsiaCity, TILESET_GEN1_OVERWORLD, TOWN, LANDMARK_FUCHSIA_CITY, MUSIC_CELADON_CITY, FALSE, PALETTE_AUTO, FISHGROUP_GYARADOS
	...
	map SafariZoneCenter, TILESET_GEN1_FOREST, ROUTE, LANDMARK_FUCHSIA_CITY, MUSIC_ROUTE_3, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SafariZoneEast, TILESET_GEN1_FOREST, ROUTE, LANDMARK_FUCHSIA_CITY, MUSIC_ROUTE_3, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SafariZoneNorth, TILESET_GEN1_FOREST, ROUTE, LANDMARK_FUCHSIA_CITY, MUSIC_ROUTE_3, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map SafariZoneWest, TILESET_GEN1_FOREST, ROUTE, LANDMARK_FUCHSIA_CITY, MUSIC_ROUTE_3, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Lavender:
	...
	map Route12, TILESET_GEN1_OVERWORLD, ROUTE, LANDMARK_ROUTE_12, MUSIC_ROUTE_12, FALSE, PALETTE_AUTO, FISHGROUP_QWILFISH_NO_SWARM
...
MapGroup_Celadon:
	...
	map Route17, TILESET_GEN1_OVERWORLD, ROUTE, LANDMARK_ROUTE_17, MUSIC_ROUTE_3, FALSE, PALETTE_AUTO, FISHGROUP_NONE
	map CeladonCity, TILESET_GEN1_OVERWORLD, TOWN, LANDMARK_CELADON_CITY, MUSIC_CELADON_CITY, FALSE, PALETTE_AUTO, FISHGROUP_NONE
...
MapGroup_Viridian:
	...
	map Route22, TILESET_GEN1_OVERWORLD, ROUTE, LANDMARK_ROUTE_22, MUSIC_ROUTE_3, FALSE, PALETTE_AUTO, FISHGROUP_POND
	map ViridianCity, TILESET_GEN1_OVERWORLD, TOWN, LANDMARK_VIRIDIAN_CITY, MUSIC_VIRIDIAN_CITY, FALSE, PALETTE_AUTO, FISHGROUP_POND
