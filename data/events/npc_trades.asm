...
; entries correspond to NPCTRADE_* constants
	...
	; Gen 1 Route 2 Trade House (TRADE_FOR_MARCEL): give ABRA, get nicknamed MR_MIME
	npctrade TRADE_DIALOGSET_NEWBIE,    ABRA,       MR_MIME,    "MARCEL", $88, $66, TWISTEDSPOON, 30301, "MARCEL", TRADE_GENDER_EITHER
