; Tilesets indexes (see data/tilesets.asm)
	...
	const TILESET_GEN1_POKECENTER
	const TILESET_GEN1_GYM
	const TILESET_GEN1_FOREST
	const TILESET_GEN1_GATE
	const TILESET_GEN1_SHIP
	const TILESET_GEN1_SHIP_PORT
	const TILESET_GEN1_CEMETERY
	const TILESET_GEN1_INTERIOR
	const TILESET_GEN1_CAVERN
	const TILESET_GEN1_LOBBY
	const TILESET_GEN1_MANSION
	const TILESET_GEN1_CLUB
	const TILESET_GEN1_FACILITY
	const TILESET_GEN1_PLATEAU
	const TILESET_GEN1_UNDERGROUND
	const TILESET_GEN1_MART
	const TILESET_GEN1_DOJO
	const TILESET_GEN1_MUSEUM
	const TILESET_GEN1_FOREST_GATE
