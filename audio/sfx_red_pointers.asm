...
; RedMusic (audio/music_red_pointers.asm). NOT currently wired to any
; runtime toggle -- see tools/port_sfx.py docstring for why. Swaps in
; the 17 confidently-name-matched Red SFX; every other entry keeps the
