...
Route2Gate_MapEvents:
	...
	def_warp_events
	; Route2's north/south doors now collapse to single slots 5/6 (issue #44 Gen 1
	; geometry fix); both physical door tiles on each side land on the same slot.
	...
	def_object_events
	object_event  1,  4, SPRITE_SCIENTIST, SPRITEMOVEDATA_STANDING_LEFT, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, Route2GateOaksAideScript, -1
