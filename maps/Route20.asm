...
Route20_MapEvents:
	...
	object_event 24, 12, SPRITE_SWIMMER_GIRL, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_GREEN, OBJECTTYPE_TRAINER, 16, TrainerSwimmerRoute20a, -1
	...
	object_event 55, 14, SPRITE_SWIMMER_GIRL, SPRITEMOVEDATA_STANDING_RIGHT, 0, 0, -1, -1, PAL_NPC_GREEN, OBJECTTYPE_TRAINER, 24, TrainerSwimmerRoute20b, -1
